...
import 'personnel_personal_details.dart';

class NonBUPersonnelForm extends StatefulWidget {
  @override
  State<NonBUPersonnelForm> createState() => _NonBUPersonnelFormState();
}

class _NonBUPersonnelFormState extends State<NonBUPersonnelForm> {
  ...
  void _handleNext() {
    setState(() {
      ...
      if (_phoneEmailError == null && _passwordError == null && _confirmPasswordError == null) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => PersonnelPersonalDetails()),
        );
      }
    });
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeInUp(duration: Duration(milliseconds: 1000), child: Text("Non BU Personnel Registration", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),)),
                  SizedBox(height: 10,),
