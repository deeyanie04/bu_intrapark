...
class BUPersonnelForm extends StatefulWidget {
  @override
  State<BUPersonnelForm> createState() => _BUPersonnelFormState();
}

class _BUPersonnelFormState extends State<BUPersonnelForm> {
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeInUp(duration: Duration(milliseconds: 1000), child: Text("BU Personnel Registration", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),)),
                  SizedBox(height: 10,),
